...
target_file_pf_other_vars= f"{path}/ECMWF_s2s_pf_othervars_forecast_42days_23N-20W-37S-59E.grib"
...
# target_file_cf_other_vars= f"{path}/ECMWF_s2s_cf_othervars_forecast_42days_23N-20W-37S-59E.grib"
...
with open("latest_file.txt", "w") as f:
    ...
    f.write("\n")
    f.write(target_file_pf_other_vars)
    f.write("\n")
    f.write(target_file_cf_other_vars)